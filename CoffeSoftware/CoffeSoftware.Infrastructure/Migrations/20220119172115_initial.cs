    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderListProduct", x => new { x.OrderListId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_OrderListProduct_OrderList_OrderListId",
                        column: x => x.OrderListId,
                        principalTable: "OrderList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderListProduct_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderListProduct_ProductId",
